...
def run(data_request):
    """
    This is the actual function when running the prediction
    Args:
        data_request: json data that can be injested into Pandas DataFrame
    Returns:
        0 for < 50K income, and 1 for >= income
    """
    try:
